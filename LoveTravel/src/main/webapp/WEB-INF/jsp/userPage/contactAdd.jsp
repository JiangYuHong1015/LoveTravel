        ...
        <form id="contactForm" class="form-horizontal form-label-left" action="contactAddSave" method="post">
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">联系姓名 <span class="required">*</span>
           	...
           	<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
	            <input class="form-control has-feedback-left" data-validate-length-range="20" data-validate-words="1"
	            name="contactName" id="contactName" required="required" placeholder="联系姓名请与证件名一致" value="">
	            <font color="red"></font>
          ...
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">证件号码 <span class="required">*</span>
           	...
           	<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
	            <input class="form-control has-feedback-left" name="cardNo" id="cardNo" required="required" placeholder="请输入有效证件号码" value="">
	            <font color="red"></font>
	            <span class="fa fa-envelope form-control-feedback left" aria-hidden="true"></span>
            </div>
          </div>
           ...
           <div class="item form-group">
            	...
            	<div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
	               <input  class="form-control has-feedback-left" name="phone" id="phone" required="required" placeholder="用于接收预定信息" value="">
	               <font color="red"></font>
